...
ON CONFLICT (id) DO NOTHING`,
	...
	// =============================================
	// Phase 11 Migrations - Browser Companion Tables
	// =============================================

	// 066: companion_grants — durable consent grants
	...
	// 067: browser_audit_log — browser action audit trail
	...
	// 068: indexes for companion tables
